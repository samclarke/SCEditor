...
g.width(a);g.width(a+(a-g.outerWidth(!0)));k.width(a);k.width(a+(a-k.outerWidth(!0)))};u=function(c){e.height(c);c-=null===a.options.toolbarContainer?h.outerHeight():0;g.height(c);g.height(c+(c-g.outerHeight(!0)));k.height(c);k.height(c+(c-k.outerHeight(!0)))};G=function(){var b=c('<div class="sceditor-grip" />'),d=c('<div class="sceditor-resize-cover" />'),m=0,f=0,g=0,j=0,o=e.width(),h=e.height(),i=!1,p,k,t,q,l;p=null==a.options.resizeMinHeight?h/2:a.options.resizeMinHeight;k=null==a.options.resizeMaxHeight?
2*h:a.options.resizeMaxHeight;t=null==a.options.resizeMinWidth?o/2:a.options.resizeMinWidth;q=null==a.options.resizeMaxWidth?2*o:a.options.resizeMaxWidth;l=function(a){var c=j+(a.pageY-f),b=g+(a.pageX-m);b>=t&&(0>q||b<=q)&&v(b);c>=p&&(0>k||c<=k)&&u(c);a.preventDefault()};e.append(b);e.append(d.hide());b.mousedown(function(a){m=a.pageX;f=a.pageY;g=e.width();j=e.height();i=!0;d.show();c(document).bind("mousemove",l);a.preventDefault()});c(document).mouseup(function(a){i&&(i=!1,d.hide(),c(document).unbind("mousemove",
l),a.preventDefault())})};y=function(b){a.updateTextareaValue();c(this).removeAttr("novalidate");this.checkValidity&&!this.checkValidity()&&b.preventDefault();c(this).attr("novalidate","novalidate")};a.destory=function(){c(document).unbind("click",x);f.removeAttr("novalidate").unbind("submit",y);c(window).unbind("resize",z);e.remove();e=null;f.removeData("sceditor").show()};H=function(){var b=c.extend({},a.options.emoticons.more,a.options.emoticons.dropdown,a.options.emoticons.hidden),d;c.each(b,
function(a,c){d=document.createElement("img");d.src=c;J.push(d)})};a.createDropDown=function(b,d,e,f){a.closeDropDown();!1!==f&&(e=c(e),e.find(":not(input,textarea)").filter(function(){return 1===this.nodeType}).attr("unselectable","on"));l=c('<div class="sceditor-dropdown sceditor-'+d+'" />').css({top:b.offset().top,left:b.offset().left}).append(e);l.appendTo(c("body"));m=!0;l.click(function(a){a.stopPropagation()})};x=function(c){!m&&3!==c.which&&a.closeDropDown();m=!1};a.closeDropDown=function(c){null!==
...
"";c(a.cloneContents().childNodes).each(function(){b+=(new XMLSerializer).serializeToString(this)});return b}};r=function(){var a=q();if(null===a)return null;if(window.getSelection&&"undefined"!==typeof a.commonAncestorContainer)return a.commonAncestorContainer;if(document.selection&&document.selection.createRange)return a.parentElement()};a.getWysiwygEditorValue=function(b){var d=g.contents().find("body"),e;c.sceditor.dom.fixNesting(d.get(0));e=d.html();!1!==b&&a.options.getHtmlHandler&&(e=a.options.getHtmlHandler(e,
...
tooltip:"Copy",errorMessage:"Your browser does not allow the copy command. Please use the keyboard shortcut Ctrl/Cmd-C"},paste:{exec:"paste",tooltip:"Paste",errorMessage:"Your browser does not allow the paste command. Please use the keyboard shortcut Ctrl/Cmd-V"},pastetext:{exec:function(b){var d=this,a=c(this._('<form><div><label for="txt">{0}</label> <textarea cols="20" rows="7" id="txt"></textarea></div></form>',this._("Paste your text inside the following box:"))).submit(function(){return!1});
a.append(c(this._('<div><input type="button" class="button" value="{0}" /></div>',this._("Insert"))).click(function(a){d.wysiwygEditorInsertText(c(this).parent("form").find("#txt").val());d.closeDropDown(!0);a.preventDefault()}));d.createDropDown(b,"pastetext",a)},tooltip:"Paste Text"},bulletlist:{exec:"insertunorderedlist",tooltip:"Bullet list"},orderedlist:{exec:"insertorderedlist",tooltip:"Numbered list"},table:{exec:function(b){var d=this,a=c(this._('<form><div><label for="rows">{0}</label><input type="text" id="rows" value="2" /></div><div><label for="cols">{1}</label><input type="text" id="cols" value="2" /></div></form>',
...
d.createDropDown(b,"insertlink",a)},tooltip:"Insert a YouTube video"},date:{exec:function(){var b=new Date,d=b.getYear(),a=b.getMonth()+1,b=b.getDate();2E3>d&&(d=1900+d);10>a&&(a="0"+a);10>b&&(b="0"+b);this.wysiwygEditorInsertHtml("<span>"+this.options.dateFormat.replace(/year/i,d).replace(/month/i,a).replace(/day/i,b)+"</span>")},tooltip:"Insert current date"},time:{exec:function(){var b=new Date,d=b.getHours(),a=b.getMinutes(),b=b.getSeconds();10>d&&(d="0"+d);10>a&&(a="0"+a);10>b&&(b="0"+b);this.wysiwygEditorInsertHtml("<span>"+
d+":"+a+":"+b+"</span>")},tooltip:"Insert current time"},print:{exec:"print",tooltip:"Print"},source:{exec:function(){this.toggleTextMode()},txtExec:function(){this.toggleTextMode()},tooltip:"View source"},ignore:{}};c.sceditor.dom={traverse:function(b,d,a,c,e){if(b)for(b=e?b.lastChild:b.firstChild;null!=b;){if(!a&&!1===d(b)||!c&&!1===this.traverse(b,d,a,c,e)||a&&!1===d(b))return!1;b=e?b.previousSibling:b.nextSibling}},rTraverse:function(b,c,a,f){this.traverse(b,c,a,f,!0)},isInline:function(b,c){if(null==
b||1!==b.nodeType)return!0;var a=(window.getComputedStyle?window.getComputedStyle(b):b.currentStyle).display;return c?"block"!==a:"inline"===a},copyCSS:function(b,c){c.style.cssText=b.style.cssText},fixNesting:function(b){var c=this;c.traverse(b,function(a){if(1===a.nodeType&&!c.isInline(a)&&c.isInline(a.parentNode)){var b;for(b=a;c.isInline(b.parentNode);)b=b.parentNode;var e=b.parentNode,h=c.extractContents(b,a);c.copyCSS(a,a);e.insertBefore(h,b);e.insertBefore(a,b)}})},findCommonAncestor:function(b,
d){return c(b).parents().has(c(d)).first()},removeWhiteSpace:function(b){var d=/[^\S|\u00A0]+/g;this.traverse(b,function(a){3===a.nodeType&&(/\S|\u00A0/.test(a.nodeValue)?d.test(a.nodeValue)&&0===c(a).parents("code").length&&(a.nodeValue=a.nodeValue.replace(d," ")):a.nodeValue=" ")})},extractContents:function(b,c){var a=this,f=a.findCommonAncestor(b,c),e=!1,h=!1;return function i(f){var l=b.ownerDocument.createDocumentFragment();a.traverse(f,function(a){if(h||a===c&&e)return h=!0,!1;a===b&&(e=!0);
var f;e?(jQuery.contains(a,c)&&1===a.nodeType&&(f=i(a),a=a.cloneNode(!1),a.appendChild(f)),l.appendChild(a)):jQuery.contains(a,b)&&1===a.nodeType&&(f=i(a),a=a.cloneNode(!1),a.appendChild(f),l.appendChild(a))});return l}(null===f?null:f.get(0))}};c.sceditor.commandExists=function(b){return"undefined"!==typeof c.sceditor.commands[b]};c.sceditor.setCommand=function(b,d,a,f){if(!b||!d)return!1;c.sceditor.commandExists(b)||(c.sceditor.commands[b]={});c.sceditor.commands[b].exec=d;a&&(c.sceditor.commands[b].tooltip=
...
":wassat:":"emoticons/wassat.png"},hidden:{":whistling:":"emoticons/whistling.png",":love:":"emoticons/wub.png"}},width:null,height:null,resizeEnabled:!0,resizeMinWidth:null,resizeMinHeight:null,resizeMaxHeight:null,resizeMaxWidth:null,getHtmlHandler:null,getTextHandler:null,dateFormat:"year-month-day",toolbarContainer:null};c.fn.sceditor=function(b){return this.each(function(){new c.sceditor(this,b)})}})(jQuery);(function(c){c.sceditorBBCodePlugin=function(b,d){var a=this,f,e,h,g;a.bbcodes=c.sceditorBBCodePlugin.bbcodes;var i={},k={},l={ul:["li"],ol:["li"],table:["tr","th"],tr:["td"],th:["td"],code:["br","p","div"],youtube:[]};g=function(a,b){var d=c.camelCase(b),e;return"text-align"===b&&(e=c(a),e.parent().css(b)!==e.css(b))?e.css(b):a.style?a.style[d]:null};f=function(b,d,e){var f;b[0].nodeName.toLowerCase();e=!!e;if(!k[e])return d;c.each(k[e],function(e,j){f=g(b[0],e);null==f||""===f||g(b.parent()[0],
e)===f||c.each(j,function(e,g){if(null===g||-1<c.inArray(f.toString(),g))d=c.isFunction(a.bbcodes[e].format)?a.bbcodes[e].format.call(a,b,d):h(a.bbcodes[e].format,d)})});return d};e=function(b,d,e){var f=b.get(0).nodeName.toLowerCase(),e=!!e;i[f]&&i[f][e]&&c.each(i[f][e],function(e,f){if(null!==f){var g=!1;c.each(f,function(a,d){if(!(null==b.attr(a)||null!==d&&0>c.inArray(b.attr(a),d)))return g=!0,!1});if(!g)return}d=c.isFunction(a.bbcodes[e].format)?a.bbcodes[e].format.call(a,b,d):h(a.bbcodes[e].format,
d)});e&&/^(br|div|p)$/.test(f)&&(e=b[0].parentNode.childNodes,!("br"===f&&1===e.length)&&!("br"===f&&e[e.length-1]===b[0])&&(d+="\n"),"br"!==f&&!c.sceditor.dom.isInline(b.parent()[0])&&b[0].previousSibling&&3===b[0].previousSibling.nodeType&&(d="\n"+d));return d};h=function(){var a=arguments;return a[0].replace(/\{(\d+)\}/g,function(b,c){return"undefined"!==typeof a[c-0+1]?a[c-0+1]:"{"+c+"}"})};a.stripQuotes=function(a){return a.replace(/^["']+/,"").replace(/["']+$/,"")};a.getHtmlHandler=function(b,
d){c.sceditor.dom.removeWhiteSpace(d[0]);return c.trim(a.elementToBbcode(d))};a.elementToBbcode=function(a){return function j(a,b){var d="";c.sceditor.dom.traverse(a,function(a){var g=c(a),h="",i=a.nodeName.toLowerCase(),m=l[i],k=!0;"object"===typeof b&&((k=-1<c.inArray(i,b))||(m=b));3!==a.nodeType?g.hasClass("sceditor-ignore")||("iframe"!==i&&(h=j(a,m)),k?(g.is("code")||(h=f(g,h),h=e(g,h),h=f(g,h,!0)),d+=e(g,h,!0)):d+=h):d+=a.nodeValue},!1,!0);return d}(a.get(0))};a.getTextHandler=function(b){var d,
e,f=/\[([^\[\s=]*?)(?:([^\[]*?))?\]((?:[\s\S(?!=\[\\\1)](?!\[\1))*?)\[\/(\1)\]/g,g=/(\S+)=((?:(?:(["'])(?:\\\3|[^\3])*?\3))|(?:[^'"\s]+))/g;e=function(b,d,e,f){var i={},j;if(e)if(e=c.trim(e),"="===e.charAt(0)&&1>=e.split("=").length-1||"url"===d)i.defaultAttr=a.stripQuotes(e.substr(1));else for("="===e.charAt(0)&&(e="defaultAttr"+e);j=g.exec(e);)i[j[1].toLowerCase()]=a.stripQuotes(j[2]);return!a.bbcodes[d]?b:c.isFunction(a.bbcodes[d].html)?a.bbcodes[d].html.call(a,d,i,f):h(a.bbcodes[d].html,f)};for(b=
b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\r/g,"").replace(/(\[\/?(?:left|center|right|justify)\])\n/g,"$1").replace(/([^\n\[\]]+)\n/g,"<div>$1</div>").replace(/\n/g,"<br />");b!==d;)d=b,b=b.replace(f,e);b=b.replace(/\[hr\]/gi,"<hr>");return b.replace(/ {2}(?=([^<\>]*?<|[^<\>]*?$))/g," &nbsp;")};c.data(b,"sceditorbbcode",a);a.options=c.extend({},c.sceditor.defaultOptions,d);(function(){c.each(a.bbcodes,function(b){"undefined"!==typeof a.bbcodes[b].tags&&c.each(a.bbcodes[b].tags,
function(d,c){var e=!!a.bbcodes[b].isBlock;i[d]=i[d]||{};i[d][e]=i[d][e]||{};i[d][e][b]=c});"undefined"!==typeof a.bbcodes[b].styles&&c.each(a.bbcodes[b].styles,function(d,c){var e=!!a.bbcodes[b].isBlock;k[e]=k[e]||{};k[e][d]=k[e][d]||{};k[e][d][b]=c})})})();new c.sceditor(b,c.extend({},a.options,{getHtmlHandler:a.getHtmlHandler,getTextHandler:a.getTextHandler}))};c.sceditorBBCodePlugin.bbcodes={b:{tags:{b:null,strong:null},styles:{"font-weight":"bold,bolder,401,700,800,900".split(",")},format:"[b]{0}[/b]",
...
styles:{"font-family":null},format:function(b,d){return"font"===b[0].nodeName.toLowerCase()&&b.attr("face")?"[font="+this.stripQuotes(b.attr("face"))+"]"+d+"[/font]":"[font="+this.stripQuotes(b.css("font-family"))+"]"+d+"[/font]"},html:function(b,d,a){return'<font face="'+d.defaultAttr+'">'+a+"</font>"}},size:{tags:{font:{size:null}},styles:{"font-size":null},format:function(b,d){var a=b.css("fontSize"),c=1;"font"===b[0].nodeName.toLowerCase()&&b.attr("size")&&(a=b.attr("size"));-1<a.indexOf("px")?
(a=a.replace("px","")-0,12<a&&(c=2),15<a&&(c=3),17<a&&(c=4),23<a&&(c=5),31<a&&(c=6),47<a&&(c=7)):c=a;return"[size="+c+"]"+d+"[/size]"},html:function(b,c,a){return'<font size="'+c.defaultAttr+'">'+a+"</font>"}},color:{tags:{font:{color:null}},styles:{color:null},format:function(b,c){var a=function(a){function b(a){a=parseInt(a,10);if(isNaN(a))return"00";a=Math.max(0,Math.min(a,255)).toString(16);return 2>a.length?"0"+a:a}var c;return(c=a.match(/rgb\((\d+),\s*?(\d+),\s*?(\d+)\)/i))?"#"+b(c[1])+b(c[2]-
0)+b(c[3]-0):a}(b.css("color"));"font"===b[0].nodeName.toLowerCase()&&b.attr("color")&&(a=b.attr("color"));return"[color="+a+"]"+c+"[/color]"},html:function(b,c,a){return'<font color="'+c.defaultAttr+'">'+a+"</font>"}},ul:{tags:{ul:null},isBlock:!0,format:"[ul]{0}[/ul]",html:"<ul>{0}</ul>"},list:{html:"<ul>{0}</ul>"},ol:{tags:{ol:null},isBlock:!0,format:"[ol]{0}[/ol]",html:"<ol>{0}</ol>"},li:{tags:{li:null},format:"[li]{0}[/li]",html:"<li>{0}</li>"},"*":{html:"<li>{0}</li>"},table:{tags:{table:null},
format:"[table]{0}[/table]",html:"<table>{0}</table>"},tr:{tags:{tr:null},format:"[tr]{0}[/tr]",html:"<tr>{0}</tr>"},th:{tags:{th:null},format:"[th]{0}[/th]",html:"<th>{0}</th>"},td:{tags:{td:null},format:"[td]{0}[/td]",html:'<td>{0}<br class="sceditor-ignore" /></td>'},emoticon:{tags:{img:{src:null,"data-sceditor-emoticon":null}},format:function(b,c){return b.attr("data-sceditor-emoticon")+c},html:"{0}"},horizontalrule:{tags:{hr:null},format:"[hr]{0}",html:"<hr />"},img:{tags:{img:{src:null}},format:function(b,
d){return"undefined"!==typeof b.attr("data-sceditor-emoticon")?d:"[img"+("="+c(b).width()+"x"+c(b).height())+"]"+b.attr("src")+"[/img]"},html:function(b,c,a){b="";"undefined"!==typeof c.width&&(b+=' width="'+c.width+'"');"undefined"!==typeof c.height&&(b+=' height="'+c.height+'"');"undefined"!==typeof c.defaultAttr&&(c=c.defaultAttr.split(/x/i),b=' width="'+c[0]+'" height="'+(2===c.length?c[1]:c[0])+'"');return"<img "+b+' src="'+a+'" />'}},url:{tags:{a:{href:null}},format:function(b,c){return"mailto:"===
b.attr("href").substr(0,7)?"[email="+b.attr("href").substr(7)+"]"+c+"[/email]":"[url="+decodeURI(b.attr("href"))+"]"+c+"[/url]"},html:function(b,c,a){if("undefined"===typeof c.defaultAttr||0===c.defaultAttr.length)c.defaultAttr=a;return'<a href="'+encodeURI(c.defaultAttr)+'">'+a+"</a>"}},email:{html:function(b,c,a){"undefined"===typeof c.defaultAttr&&(c.defaultAttr=a);return'<a href="mailto:'+c.defaultAttr+'">'+a+"</a>"}},quote:{tags:{blockquote:null},isBlock:!0,format:function(b,d){var a="";1===
c(b).children("cite:first").length&&(a="="+c(b).children("cite:first").text(),c(b).children("cite:first").remove(),d=this.elementToBbcode(c(b)));return"[quote"+a+"]"+d+"[/quote]"},html:function(b,c,a){"undefined"!==typeof c.defaultAttr&&(a="<cite>"+c.defaultAttr+"</cite>"+a);return"<blockquote>"+a+"</blockquote>"}},code:{tags:{code:null},isBlock:!0,format:"[code]{0}[/code]",html:"<code>{0}</code>"},left:{styles:{"text-align":["left","-webkit-left","-moz-left","-khtml-left"]},isBlock:!0,format:"[left]{0}[/left]",
html:'<div align="left">{0}</div>'},center:{styles:{"text-align":["center","-webkit-center","-moz-center","-khtml-center"]},isBlock:!0,format:"[center]{0}[/center]",html:'<div align="center">{0}</div>'},right:{styles:{"text-align":["right","-webkit-right","-moz-right","-khtml-right"]},isBlock:!0,format:"[right]{0}[/right]",html:'<div align="right">{0}</div>'},justify:{styles:{"text-align":["justify","-webkit-justify","-moz-justify","-khtml-justify"]},isBlock:!0,format:"[justify]{0}[/justify]",html:'<div align="justify">{0}</div>'},
youtube:{tags:{iframe:{"data-youtube-id":null}},format:function(b,c){return!b.attr("data-youtube-id")?c:"[youtube]"+b.attr("data-youtube-id")+"[/youtube]"},html:'<iframe width="560" height="315" src="http://www.youtube.com/embed/{0}?wmode=opaque" data-youtube-id="{0}" frameborder="0" allowfullscreen></iframe>'},ignore:{}};c.sceditorBBCodePlugin.commandExists=function(b){return"undefined"!==typeof c.sceditorBBCodePlugin.bbcodes[b]};c.sceditorBBCodePlugin.setCommand=function(b,d,a,f,e){if(!b||!f||!e)return!1;
c.sceditorBBCodePlugin.commandExists(b)||(c.sceditorBBCodePlugin.bbcodes[b]={});c.sceditorBBCodePlugin.bbcodes[b].format=f;c.sceditorBBCodePlugin.bbcodes[b].html=e;d&&(c.sceditorBBCodePlugin.bbcodes[b].tags=d);a&&(c.sceditorBBCodePlugin.bbcodes[b].styles=a);return!0};c.fn.sceditorBBCodePlugin=function(b){return this.each(function(){new c.sceditorBBCodePlugin(this,b)})}})(jQuery);
