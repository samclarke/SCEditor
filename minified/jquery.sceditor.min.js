...
function(c,b){return"undefined"!==typeof a[b-0+1]?a[b-0+1]:"{"+b+"}"})};a.stripQuotes=function(a){return a.replace(/^["']+/,"").replace(/["']+$/,"")};a.getHtmlHandler=function(b,c){return a.elementToBbcode(c)};a.elementToBbcode=function(a){return function q(a,c){var b="";d.sceditor.dom.traverse(a,function(a){var g=d(a),i="",h=a.nodeName.toLowerCase(),j=k[h],m=!0;"object"===typeof c&&((m=-1<d.inArray(h,c))||(j=c));3!==a.nodeType?g.hasClass("sceditor-ignore")||("iframe"!==h&&(i=q(a,j)),m?(g.is("code")||
