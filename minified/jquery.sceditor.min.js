(function(d){d.sceditor=function(b,c){var a=this,e=d(b),f=null,i=null,g=null,h=null,k=null,j=null,n=!1,q=[],m=null,r=null,J=[],o,p,z,A,B,v,C,D,E,F,G,w,x,H,l,y,t,u,I,s;a.commands=d.sceditor.commands;D=function(){var c=d('<div contenteditable="true">')[0].contentEditable,c="undefined"!==typeof c&&"inherit"!==c;k=d("<textarea></textarea>").hide();g=d('<iframe frameborder="0"></iframe>');"https:"===window.location.protocol&&g.attr("src","javascript:false");f.append(g).append(k);h=g[0];u(e.width());t(e.height());
c||(l().designMode="On");l().open();l().write('<html><head><link rel="stylesheet" type="text/css" href="'+a.options.style+'" /><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" /></head><body contenteditable="true"></body></html>');l().close();c||(l().designMode="On");d(l()).find("body").keypress(v);d(l()).keypress(v);d(l()).mousedown(C);d(l()).bind("beforedeactivate keypress",B);d(l()).focus(function(){m=null})};E=function(){var c=function(c){A(d(this),a.commands[d(this).data("sceditor-command")]);
c.preventDefault()};i=d('<div class="sceditor-toolbar" />');var b=a.options.toolbar.split("|"),e,n,j,g;for(g=0;g<b.length;g++){e=d('<div class="sceditor-group" />');n=b[g].split(",");for(var h=0;h<n.length;h++)a.commands.hasOwnProperty(n[h])&&(j=a.commands[n[h]].tooltip?a._(a.commands[n[h]].tooltip):n[h],j=d('<a class="sceditor-button sceditor-button-'+n[h]+' " unselectable="on"><div unselectable="on">'+j+"</div></a>"),a.commands[n[h]].hasOwnProperty("tooltip")&&j.attr("title",a._(a.commands[n[h]].tooltip)),
a.commands[n[h]].exec?j.data("sceditor-wysiwygmode",!0):j.addClass("disabled"),a.commands[n[h]].txtExec&&j.data("sceditor-txtmode",!0),j.data("sceditor-command",n[h]),j.click(c),e.append(j));i.append(e)}null===a.options.toolbarContainer?f.append(i):d(a.options.toolbarContainer).append(i)};F=function(){d.each(a.commands,function(a,c){"undefined"!==typeof c.keyPress&&q.push(c.keyPress)})};u=function(a){f.width(a);g.width(a);g.width(a+(a-g.outerWidth(!0)));k.width(a);k.width(a+(a-k.outerWidth(!0)))};
t=function(c){f.height(c);c-=null===a.options.toolbarContainer?i.outerHeight():0;g.height(c);g.height(c+(c-g.outerHeight(!0)));k.height(c);k.height(c+(c-k.outerHeight(!0)))};G=function(){var c=d('<div class="sceditor-grip" />'),b=d('<div class="sceditor-resize-cover" />'),e=0,n=0,j=0,g=0,i=f.width(),h=f.height(),m=!1,q,p,k,o,l;q=null==a.options.resizeMinHeight?h/2:a.options.resizeMinHeight;p=null==a.options.resizeMaxHeight?2*h:a.options.resizeMaxHeight;k=null==a.options.resizeMinWidth?i/2:a.options.resizeMinWidth;
o=null==a.options.resizeMaxWidth?2*i:a.options.resizeMaxWidth;l=function(a){var c=g+(a.pageY-n),d=j+(a.pageX-e);d>=k&&(0>o||d<=o)&&u(d);c>=q&&(0>p||c<=p)&&t(c);a.preventDefault()};f.append(c);f.append(b.hide());c.mousedown(function(a){e=a.pageX;n=a.pageY;j=f.width();g=f.height();m=!0;b.show();d(document).bind("mousemove",l);a.preventDefault()});d(document).mouseup(function(a){m&&(m=!1,b.hide(),d(document).unbind("mousemove",l),a.preventDefault())})};x=function(c){a.updateTextareaValue();d(this).removeAttr("novalidate");
this.checkValidity&&!this.checkValidity()&&c.preventDefault();d(this).attr("novalidate","novalidate")};a.destory=function(){d(document).unbind("click",w);e.removeAttr("novalidate").unbind("submit",x);d(window).unbind("resize",y);f.remove();f=null;e.removeData("sceditor").show()};H=function(){var c=d.extend({},a.options.emoticons.more,a.options.emoticons.dropdown,a.options.emoticons.hidden);d.each(c,function(a,c){var d=document.createElement("img");d.src=c;J.push(d)})};a.createDropDown=function(c,
b,e,f){a.closeDropDown();!1!==f&&(e=d(e),e.find(":not(input,textarea)").filter(function(){return 1===this.nodeType}).attr("unselectable","on"));j=d('<div class="sceditor-dropdown sceditor-'+b+'" />').css({top:c.offset().top,left:c.offset().left}).append(e);j.appendTo(d("body"));n=!0;j.click(function(a){a.stopPropagation()})};w=function(c){!n&&3!==c.which&&a.closeDropDown();n=!1};a.closeDropDown=function(c){null!==j&&(j.remove(),j=null);!0===c&&a.focus()};l=function(){return h.contentDocument?h.contentDocument:
...
h.contentWindow.getSelection().addRange(b)}else l().selection&&l().selection.createRange?l().selection.createRange().pasteHTML(c):a.execCommand("insertHtml",c);m=null}};a.wysiwygEditorInsertText=function(c){c=c.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/ /g,"&nbsp;").replace(/\r\n|\r/g,"\n").replace(/\n/g,"<br />");a.wysiwygEditorInsertHtml("<span>"+c+"</span>")};p=function(){var a;h.contentWindow&&h.contentWindow.getSelection?a=h.contentWindow.getSelection():l().selection&&
(a=l().selection);a.getRangeAt&&0>=a.rangeCount&&a.addRange(l().createRange());return a.getRangeAt?a.getRangeAt(0):a.createRange?a.createRange():null};a.getWysiwygSelectedHtml=function(){var a=p();if(null===a)return"";if(document.selection&&document.selection.createRange){if(""===a.text)return"";if("undefined"!==typeof a.htmlText)return a.htmlText}if(window.XMLSerializer){var c="";d(a.cloneContents().childNodes).each(function(){c+=(new XMLSerializer).serializeToString(this)});return c}};o=function(){var a=
p();if(null===a)return null;if(window.getSelection&&"undefined"!==typeof a.commonAncestorContainer)return a.commonAncestorContainer;if(document.selection&&document.selection.createRange)return a.parentElement()};a.getWysiwygEditorValue=function(c){var b=g.contents().find("body");d.sceditor.dom.fixNesting(b.get(0));var e=b.html();!1!==c&&a.options.getHtmlHandler&&(e=a.options.getHtmlHandler(e,b));return e};a.getTextareaValue=function(c){var d=k.val();!1!==c&&a.options.getTextHandler&&(d=a.options.getTextHandler(d));
return d};a.setWysiwygEditorValue=function(a){l().body.innerHTML=z(a)};a.setTextareaValue=function(a){k.val(a)};a.updateTextareaValue=function(){s()?e.val(a.getTextareaValue(!1)):e.val(a.getWysiwygEditorValue())};z=function(c){var b=d.extend({},a.options.emoticons.more,a.options.emoticons.dropdown,a.options.emoticons.hidden);d.each(b,function(d,b){var e=a.regexEscape(d)+"(?=([^\\<\\>]*?<(?!/code)|[^\\<\\>]*?$))",f="";a.options.emoticonsCompat&&(e="((>|^|\\s){1})"+e+"(?=(\\s|$|<){1})",f="$1");c=c.replace(RegExp(e,
"gm"),f+'<img src="'+b+'" data-sceditor-emoticon="'+d+'" />')});return c};a.regexEscape=function(a){return a.replace(/[\$\?\[\]\.\*\(\)\|]/g,"\\$&").replace("<","&lt;").replace(">","&gt;")};s=function(){return k.is(":visible")};a.toggleTextMode=function(){s()?a.setWysiwygEditorValue(a.getTextareaValue()):a.setTextareaValue(a.getWysiwygEditorValue());i.find(".sceditor-button").removeClass("disabled");m=null;k.toggle();g.toggle();i.find(".sceditor-button").each(function(){var a=d(this);s()&&!a.data("sceditor-txtmode")?
a.addClass("disabled"):!s()&&!a.data("sceditor-wysiwygmode")&&a.addClass("disabled")})};A=function(c,b){s()?b.hasOwnProperty("txtExec")&&b.txtExec.call(a,c):b.hasOwnProperty("exec")&&(d.isFunction(b.exec)?b.exec.call(a,c):a.execCommand(b.exec,b.hasOwnProperty("execParam")?b.execParam:null))};a.focus=function(){h.contentWindow.focus();null!==m&&(window.document.createRange?window.getSelection().addRange(m):window.document.selection&&m.select(),m=null)};B=function(){d.browser.msie&&(m=p())};a.execCommand=
function(c,b){var e=!1;a.focus();if(!(d(o()).is("code")||0!==d(o()).parents("code").length)){if(l())try{e=l().execCommand(c,!1,b)}catch(f){}!e&&"undefined"!==typeof a.commands[c]&&"undefined"!==typeof a.commands[c].errorMessage&&alert(a._(a.commands[c].errorMessage))}};v=function(c){a.closeDropDown();var b=o(),b=d(b);if(13===c.which&&(b.is("code, blockquote")||0!==b.parents("code, blockquote").length))return a.wysiwygEditorInsertHtml("<br />",null,!0),!1;var e=l();d.sceditor.dom.rTraverse(e.body,
function(a){if(3===a.nodeType&&""!==a.nodeValue||"br"===a.nodeName.toLowerCase())return 0<d(a).parents("code, blockquote").length&&d(e.body).append(e.createElement("br")),!1},!0);if(!(b.is("code")||0!==b.parents("code").length))for(b=q.length;b--;)q[b].call(a,c,h,k)};C=function(){a.closeDropDown();m=null};y=function(){null!==a.options.height&&-1<a.options.height.toString().indexOf("%")&&t(f.parent().height()*(parseFloat(a.options.height)/100));null!==a.options.width&&-1<a.options.width.toString().indexOf("%")&&
u(f.parent().width()*(parseFloat(a.options.width)/100))};a._=function(){var a=arguments;null!==r&&r[a[0]]&&(a[0]=r[a[0]]);return a[0].replace(/\{(\d+)\}/g,function(c,b){return"undefined"!==typeof a[b-0+1]?a[b-0+1]:"{"+b+"}"})};I=function(){if(d.sceditor.locale[a.options.locale])r=d.sceditor.locale[a.options.locale];else{var c=a.options.locale.split("-");d.sceditor.locale[c[0]]&&(r=d.sceditor.locale[c[0]])}null!==r&&r.dateFormat&&(a.options.dateFormat=r.dateFormat)};(function(){e.data("sceditor",a);
a.options=d.extend({},d.sceditor.defaultOptions,c);null!==a.options.locale&&"en"!==a.options.locale&&I();null!==a.options.height&&e.height(a.options.height);null!==a.options.width&&e.width(a.options.width);(null!==a.options.height&&-1<a.options.height.toString().indexOf("%")||null!==a.options.width&&-1<a.options.width.toString().indexOf("%"))&&d(window).resize(y);f=d('<div class="sceditor-container" />').width(e.outerWidth()).height(e.outerHeight());e.after(f);E();D();F();a.options.resizeEnabled&&
G();d(document).click(w);e.parents("form").attr("novalidate","novalidate").submit(x);var b=e.hide().val();a.options.getTextHandler&&(b=a.options.getTextHandler(b));a.setWysiwygEditorValue(b);-1!=a.options.toolbar.indexOf("emoticon")&&H()})()};d.sceditor.locale={};d.sceditor.commands={bold:{exec:"bold",tooltip:"Bold"},italic:{exec:"italic",tooltip:"Italic"},underline:{exec:"underline",tooltip:"Underline"},strike:{exec:"strikethrough",tooltip:"Strikethrough"},subscript:{exec:"subscript",tooltip:"Subscript"},
superscript:{exec:"superscript",tooltip:"Superscript"},left:{exec:"justifyleft",tooltip:"Align left"},center:{exec:"justifycenter",tooltip:"Center"},right:{exec:"justifyright",tooltip:"Align right"},justify:{exec:"justifyfull",tooltip:"Justify"},font:{exec:function(b){for(var c=this,a=c.options.fonts.split(","),e=d("<div />"),f=function(a){c.execCommand("fontname",d(this).data("sceditor-font"));c.closeDropDown(!0);a.preventDefault()},i=0;i<a.length;i++)e.append(d('<a class="sceditor-font-option" href="#"><font face="'+
a[i]+'">'+a[i]+"</font></a>").data("sceditor-font",a[i]).click(f));c.createDropDown(b,"font-picker",e)},tooltip:"Font Name"},size:{exec:function(b){for(var c=this,a=d("<div />"),e=function(a){c.execCommand("fontsize",d(this).data("sceditor-fontsize"));c.closeDropDown(!0);a.preventDefault()},f=1;7>=f;f++)a.append(d('<a class="sceditor-fontsize-option" href="#"><font size="'+f+'">'+f+"</font></a>").data("sceditor-fontsize",f).click(e));c.createDropDown(b,"fontsize-picker",a)},tooltip:"Font Size"},color:{exec:function(b){for(var c=
this,a={r:255,g:255,b:255},e=d("<div />"),f=this.options.colors?this.options.colors.split("|"):Array(21),i=[],g=0,h=0;h<f.length;++h){var k="undefined"!==typeof f[h]?f[h].split(","):Array(21);i[g++]='<div class="sceditor-color-column">';for(var j=0;j<k.length;++j){var n="undefined"!==typeof k[j]?k[j]:"#"+a.r.toString(16)+a.g.toString(16)+a.b.toString(16);i[g++]='<a href="#" class="sceditor-color-option" style="background-color: '+n+'" data-color="'+n+'"></a>';a=0===j%5?{r:a.r,g:a.g-51,b:255}:{r:a.r,
...
function(c,b){return"undefined"!==typeof a[b-0+1]?a[b-0+1]:"{"+b+"}"})};a.stripQuotes=function(a){return a.replace(/^["']+/,"").replace(/["']+$/,"")};a.getHtmlHandler=function(c,b){return a.elementToBbcode(b)};a.elementToBbcode=function(a){return function q(a,c){var b="";d.sceditor.dom.traverse(a,function(a){var g=d(a),h="",i=a.nodeName.toLowerCase(),j=k[i],m=!0;"object"===typeof c&&((m=-1<d.inArray(i,c))||(j=c));3!==a.nodeType?g.hasClass("sceditor-ignore")||("iframe"!==i&&(h=q(a,j)),m?(g.is("code")||
(h=e(g,h),h=f(g,h),h=e(g,h,!0)),b+=f(g,h,!0)):b+=h):b+=a.nodeValue},!1,!0);return b}(a.get(0))};a.getTextHandler=function(b){for(var c=/\[([^\[\s=]*?)(?:([^\[]*?))?\]((?:[\s\S(?!=\[\\\1)](?!\[\1))*?)\[\/(\1)\]/g,e=/(\S+)=((?:(?:(["'])(?:\\\3|[^\3])*?\3))|(?:[^'"\s]+))/g,f,g=function(b,c,f,g){var h={},j;if(f)if(f=d.trim(f),"="===f.charAt(0)&&1>=f.split("=").length-1||"url"===c)h.defaultAttr=a.stripQuotes(f.substr(1));else for("="===f.charAt(0)&&(f="defaultAttr"+f);j=e.exec(f);)h[j[1].toLowerCase()]=
