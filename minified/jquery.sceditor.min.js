...
f.after(e);F();E();G();a.options.resizeEnabled&&H();d(document).click(y);f.parents("form").attr("novalidate","novalidate").submit(z);a.options.emoticonsRoot&&a.options.emoticons&&d.each(a.options.emoticons,function(b,c){d.each(c,function(c,d){a.options.emoticons[b][c]=a.options.emoticonsRoot+d})});var b=f.hide().val();a.options.getTextHandler&&(b=a.options.getTextHandler(b));a.setWysiwygEditorValue(b);-1!==a.options.toolbar.indexOf("emoticon")&&I()})()};d.sceditor.locale={};d.sceditor.commands={bold:{exec:"bold",
tooltip:"Bold"},italic:{exec:"italic",tooltip:"Italic"},underline:{exec:"underline",tooltip:"Underline"},strike:{exec:"strikethrough",tooltip:"Strikethrough"},subscript:{exec:"subscript",tooltip:"Subscript"},superscript:{exec:"superscript",tooltip:"Superscript"},left:{exec:"justifyleft",tooltip:"Align left"},center:{exec:"justifycenter",tooltip:"Center"},right:{exec:"justifyright",tooltip:"Align right"},justify:{exec:"justifyfull",tooltip:"Justify"},font:{exec:function(b){for(var c=this,a=c.options.fonts.split(","),
f=d("<div />"),e=function(a){c.execCommand("fontname",d(this).data("sceditor-font"));c.closeDropDown(!0);a.preventDefault()},h=0;h<a.length;h++)f.append(d('<a class="sceditor-font-option" href="#"><font face="'+a[h]+'">'+a[h]+"</font></a>").data("sceditor-font",a[h]).click(e));c.createDropDown(b,"font-picker",f)},tooltip:"Font Name"},size:{exec:function(b){for(var c=this,a=d("<div />"),f=function(a){c.execCommand("fontsize",d(this).data("sceditor-fontsize"));c.closeDropDown(!0);a.preventDefault()},
e=1;7>=e;e++)a.append(d('<a class="sceditor-fontsize-option" href="#"><font size="'+e+'">'+e+"</font></a>").data("sceditor-fontsize",e).click(f));c.createDropDown(b,"fontsize-picker",a)},tooltip:"Font Size"},color:{exec:function(b){for(var c=this,a={r:255,g:255,b:255},f=d("<div />"),e=this.options.colors?this.options.colors.split("|"):Array(21),h=[],g=0,i=0;i<e.length;++i){var j="undefined"!==typeof e[i]?e[i].split(","):Array(21);h[g++]='<div class="sceditor-color-column">';for(var m=0;m<j.length;++m){var p=
"undefined"!==typeof j[m]?j[m]:"#"+a.r.toString(16)+a.g.toString(16)+a.b.toString(16);h[g++]='<a href="#" class="sceditor-color-option" style="background-color: '+p+'" data-color="'+p+'"></a>';a=0===m%5?{r:a.r,g:a.g-51,b:255}:{r:a.r,g:a.g,b:a.b-51}}h[g++]="</div>";a=0===i%5?{r:a.r-51,g:255,b:255}:{r:a.r,g:255,b:255}}f.append(h.join("")).find("a").click(function(a){c.execCommand("forecolor",d(this).attr("data-color"));c.closeDropDown(!0);a.preventDefault()});c.createDropDown(b,"color-picker",f)},tooltip:"Font Color"},
removeformat:{exec:"removeformat",tooltip:"Remove Formatting"},cut:{exec:"cut",tooltip:"Cut",errorMessage:"Your browser does not allow the cut command. Please use the keyboard shortcut Ctrl/Cmd-X"},copy:{exec:"copy",tooltip:"Copy",errorMessage:"Your browser does not allow the copy command. Please use the keyboard shortcut Ctrl/Cmd-C"},paste:{exec:"paste",tooltip:"Paste",errorMessage:"Your browser does not allow the paste command. Please use the keyboard shortcut Ctrl/Cmd-V"},pastetext:{exec:function(b){var c=
this,a=d(this._('<form><div><label for="txt">{0}</label> <textarea cols="20" rows="7" id="txt"></textarea></div></form>',this._("Paste your text inside the following box:"))).submit(function(){return!1});a.append(d(this._('<div><input type="button" class="button" value="{0}" /></div>',this._("Insert"))).click(function(a){c.wysiwygEditorInsertText(d(this).parent("form").find("#txt").val());c.closeDropDown(!0);a.preventDefault()}));c.createDropDown(b,"pastetext",a)},tooltip:"Paste Text"},bulletlist:{exec:"insertunorderedlist",
...
0,h=d(this).parent("form").find("#cols").val()-0,g="<table>";if(!(1>b||1>h)){for(var i=0;i<b;i++){for(var g=g+"<tr>",j=0;j<h;j++)g=d.browser.msie?g+"<td></td>":g+'<td><br class="sceditor-ignore" /></td>';g+="</tr>"}c.wysiwygEditorInsertHtml(g+"</table>");c.closeDropDown(!0);a.preventDefault()}}));c.createDropDown(b,"inserttable",a)},tooltip:"Insert a table"},horizontalrule:{exec:"inserthorizontalrule",tooltip:"Insert a horizontal rule"},code:{exec:function(){this.wysiwygEditorInsertHtml("<code>",
...
this._("Insert"))).click(function(a){var b=d(this).parent("form"),h=b.find("#image").val(),g="",i;if(i=b.find("#width").val())g+=' width="'+i+'"';if(b=b.find("#height").val())g+=' height="'+b+'"';h&&"http://"!==h&&c.wysiwygEditorInsertHtml("<img"+g+' src="'+h+'" />');c.closeDropDown(!0);a.preventDefault()}));c.createDropDown(b,"insertimage",a)},tooltip:"Insert an image"},email:{exec:function(b){var c=this,a=d(this._('<form><div><label for="email">{0}</label> <input type="text" id="email" value="" /></div></form>',
...
this._("URL:"),this._("Description (optional):"))).submit(function(){return!1});a.append(d(this._('<div><input type="button" class="button" value="{0}" /></div>',this._("Insert"))).click(function(a){var b=d(this).parent("form").find("#link").val(),h=d(this).parent("form").find("#des").val();""!==b&&"http://"!==b&&(c.focus(),!c.getWysiwygSelectedHtml()||h?(h||(h=b),c.wysiwygEditorInsertHtml('<a href="'+b+'">'+h+"</a>")):c.execCommand("createlink",b));c.closeDropDown(!0);a.preventDefault()}));c.createDropDown(b,
"insertlink",a)},tooltip:"Insert a link"},unlink:{exec:"unlink",tooltip:"Unlink"},quote:{exec:function(b,c,a){var b="<blockquote>",d="</blockquote>";c?(b=b+(a?"<cite>"+a+"</cite>":"")+c+d+"<br />",d=null):""===this.getWysiwygSelectedHtml()&&(d="<br />"+d);this.wysiwygEditorInsertHtml(b,d)},tooltip:"Insert a Quote"},emoticon:{exec:function(b){var c,a=this,f=d("<div />"),e=d("<div />");c=function(b,c){e.append(d("<img />").attr({src:c,alt:b}).click(function(b){var c="",e="";a.options.emoticonsCompat&&
(c="<span> ",e=" </span>");a.wysiwygEditorInsertHtml(c+'<img src="'+d(this).attr("src")+'" data-sceditor-emoticon="'+d(this).attr("alt")+'" />'+e);a.closeDropDown(!0);b.preventDefault()}));3<e.children().length&&(f.append(e),e=d("<div />"))};d.each(a.options.emoticons.dropdown,c);0<e.children().length&&f.append(e);if("undefined"!==typeof a.options.emoticons.more){var h=d(this._('<a class="sceditor-more">{0}</a>',this._("More"))).click(function(){var h=d.extend({},a.options.emoticons.dropdown,a.options.emoticons.more);
f=d("<div />");e=d("<div />");d.each(h,c);0<e.children().length&&f.append(e);a.createDropDown(b,"insertemoticon",f)});f.append(h)}a.createDropDown(b,"insertemoticon",f)},keyPress:function(b,c){var a=null,f=-1,e=this;c.contentWindow&&c.contentWindow.getSelection&&(a=c.contentWindow.getSelection().getRangeAt(0));if(null!=a&&a.startContainer){e.allEmoticonCache||(e.allEmoticonCache=d.extend({},e.options.emoticons.more,e.options.emoticons.dropdown,e.options.emoticons.hidden));e.longestEmoticonCode||(e.longestEmoticonCode=
0,d.each(e.allEmoticonCache,function(a){a.length>e.longestEmoticonCode&&(e.longestEmoticonCode=a.length)}),e.options.emoticonsCompat&&(e.longestEmoticonCode+=1));var h=String.fromCharCode(b.which),g=e.options.emoticonsCompat?/\s/.test(h):!1,i=a.startContainer.textContent.substr(0,a.startOffset),j=a.startContainer.textContent.substr(a.startOffset,e.longestEmoticonCode),m=i+h+j;d.each(e.allEmoticonCache,function(d,l){if(-1<(f=m.indexOf(d,a.startOffset-d.length))){if(e.options.emoticonsCompat){var k=
RegExp("(\\s{1})"+e.regexEscape(d)+"(?=\\s{1})","gm");if(g&&-1<(h+j).indexOf(d)||!k.test(m))return}a=a.cloneRange();a.setStart(a.startContainer,f);a.setEnd(a.startContainer,f+d.length-(g?0:1));a.deleteContents();k=c.contentDocument.createElement("div");k.innerHTML='<img src="'+l+'" data-sceditor-emoticon="'+d+'" alt="'+d+'" />';k=k.children[0];a.insertNode(k);a=a.cloneRange();a.setStartAfter(k);c.contentWindow.getSelection().removeAllRanges();c.contentWindow.getSelection().addRange(a);g||(b.preventDefault(),
b.stopPropagation());return!1}})}},tooltip:"Insert an emoticon"},youtube:{exec:function(b){var c=this,a=d(this._('<form><div><label for="link">{0}</label> <input type="text" id="link" value="http://" /></div></form>',this._("Video URL:"))).submit(function(){return!1});a.append(d(this._('<div><input type="button" class="button" value="{0}" /></div>',this._("Insert"))).click(function(a){var b=d(this).parent("form").find("#link").val();""!==b&&"http://"!==b&&(b=b.replace(/^[^v]+v.(.{11}).*/,"$1"),c.wysiwygEditorInsertHtml('<iframe width="560" height="315" src="http://www.youtube.com/embed/'+
b+'?wmode=opaque" data-youtube-id="'+b+'" frameborder="0" allowfullscreen></iframe>'));c.closeDropDown(!0);a.preventDefault()}));c.createDropDown(b,"insertlink",a)},tooltip:"Insert a YouTube video"},date:{exec:function(){var b=new Date,c=b.getYear(),a=b.getMonth()+1,b=b.getDate();2E3>c&&(c=1900+c);10>a&&(a="0"+a);10>b&&(b="0"+b);this.wysiwygEditorInsertHtml("<span>"+this.options.dateFormat.replace(/year/i,c).replace(/month/i,a).replace(/day/i,b)+"</span>")},tooltip:"Insert current date"},time:{exec:function(){var b=
new Date,c=b.getHours(),a=b.getMinutes(),b=b.getSeconds();10>c&&(c="0"+c);10>a&&(a="0"+a);10>b&&(b="0"+b);this.wysiwygEditorInsertHtml("<span>"+c+":"+a+":"+b+"</span>")},tooltip:"Insert current time"},print:{exec:"print",tooltip:"Print"},source:{exec:function(){this.toggleTextMode()},txtExec:function(){this.toggleTextMode()},tooltip:"View source"},ignore:{}};d.sceditor.dom={traverse:function(b,c,a,d,e){if(b)for(b=e?b.lastChild:b.firstChild;null!=b;){if(!a&&!1===c(b)||!d&&!1===this.traverse(b,c,a,
d,e)||a&&!1===c(b))return!1;b=e?b.previousSibling:b.nextSibling}},rTraverse:function(b,d,a,f){this.traverse(b,d,a,f,!0)},isInline:function(b,d){if(null==b||1!==b.nodeType)return!0;var a=(window.getComputedStyle?window.getComputedStyle(b):b.currentStyle).display;return d?"block"!==a:"inline"===a},copyCSS:function(b,d){d.style.cssText=b.style.cssText},fixNesting:function(b){var d=this;d.traverse(b,function(a){if(1===a.nodeType&&!d.isInline(a)&&d.isInline(a.parentNode)){var b;for(b=a;d.isInline(b.parentNode);)b=
b.parentNode;var e=b.parentNode,h=d.extractContents(b,a);d.copyCSS(a,a);e.insertBefore(h,b);e.insertBefore(a,b)}})},findCommonAncestor:function(b,c){return d(b).parents().has(d(c)).first()},removeWhiteSpace:function(b){var c=/[^\S|\u00A0]+/g;this.traverse(b,function(a){3===a.nodeType&&0===d(a).parents("code, pre").length&&(/\S|\u00A0/.test(a.nodeValue)?c.test(a.nodeValue)&&(a.nodeValue=a.nodeValue.replace(c," ")):a.nodeValue=" ")})},extractContents:function(b,d){var a=this,f=a.findCommonAncestor(b,
d),e=!1,h=!1;return function i(f){var m=b.ownerDocument.createDocumentFragment();a.traverse(f,function(a){if(h||a===d&&e)return h=!0,!1;a===b&&(e=!0);var l;e?(jQuery.contains(a,d)&&1===a.nodeType&&(l=i(a),a=a.cloneNode(!1),a.appendChild(l)),m.appendChild(a)):jQuery.contains(a,b)&&1===a.nodeType&&(l=i(a),a=a.cloneNode(!1),a.appendChild(l),m.appendChild(a))});return m}(null===f?null:f.get(0))}};d.sceditor.commandExists=function(b){return"undefined"!==typeof d.sceditor.commands[b]};d.sceditor.setCommand=
function(b,c,a,f){if(!b||!c)return!1;d.sceditor.commandExists(b)||(d.sceditor.commands[b]={});d.sceditor.commands[b].exec=c;a&&(d.sceditor.commands[b].tooltip=a);f&&(d.sceditor.commands[b].keyPress=f);return!0};d.sceditor.defaultOptions={toolbar:"bold,italic,underline,strike,subscript,superscript|left,center,right,justify|font,size,color,removeformat|cut,copy,paste,pastetext|bulletlist,orderedlist|table|code,quote|horizontalrule,image,email,link,unlink|emoticon,youtube,date,time|print,source",style:"jquery.sceditor.default.css",
fonts:"Arial,Arial Black,Comic Sans MS,Courier New,Georgia,Impact,Sans-serif,Serif,Times New Roman,Trebuchet MS,Verdana",colors:null,locale:"en",charset:"utf-8",emoticonsCompat:!1,emoticonsRoot:"",emoticons:{dropdown:{":)":"emoticons/smile.png",":angel:":"emoticons/angel.png",":angry:":"emoticons/angry.png","8-)":"emoticons/cool.png",":'(":"emoticons/cwy.png",":ermm:":"emoticons/ermm.png",":D":"emoticons/grin.png","<3":"emoticons/heart.png",":(":"emoticons/sad.png",":O":"emoticons/shocked.png",":P":"emoticons/tongue.png",
";)":"emoticons/wink.png"},more:{":alien:":"emoticons/alien.png",":blink:":"emoticons/blink.png",":blush:":"emoticons/blush.png",":cheerful:":"emoticons/cheerful.png",":devil:":"emoticons/devil.png",":dizzy:":"emoticons/dizzy.png",":getlost:":"emoticons/getlost.png",":happy:":"emoticons/happy.png",":kissing:":"emoticons/kissing.png",":ninja:":"emoticons/ninja.png",":pinch:":"emoticons/pinch.png",":pouty:":"emoticons/pouty.png",":sick:":"emoticons/sick.png",":sideways:":"emoticons/sideways.png",":silly:":"emoticons/silly.png",
