...
(new XMLSerializer).serializeToString(this)});return c}};o=function(){var a=p();if(null===a)return null;if(window.getSelection&&"undefined"!==typeof a.commonAncestorContainer)return a.commonAncestorContainer;if(document.selection&&document.selection.createRange)return a.parentElement()};a.getWysiwygEditorValue=function(c){var b=g.contents().find("body");d.sceditor.dom.fixNesting(b.get(0));var e=b.html();!1!==c&&a.options.getHtmlHandler&&(e=a.options.getHtmlHandler(e,b));return e};a.getTextareaValue=
function(c){var d=k.val();!1!==c&&a.options.getTextHandler&&(d=a.options.getTextHandler(d));return d};a.setWysiwygEditorValue=function(a){l().body.innerHTML=w(a)};a.setTextareaValue=function(a){k.val(a)};a.updateTextareaValue=function(){s()?e.val(a.getTextareaValue(!1)):e.val(a.getWysiwygEditorValue())};w=function(c){var b=d.extend({},a.options.emoticons.more,a.options.emoticons.dropdown,a.options.emoticons.hidden);d.each(b,function(d,b){var e=a.regexEscape(d)+"(?=([^\\<\\>]*?<(?!/code)|[^\\<\\>]*?$))",
