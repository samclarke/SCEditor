...
document.selection.createRange)return a.parentElement()};a.getWysiwygEditorValue=function(c){var b=g.contents().find("body");d.sceditor.dom.fixNesting(b.get(0));var e=b.html();!1!==c&&a.options.getHtmlHandler&&(e=a.options.getHtmlHandler(e,b));return e};a.getTextareaValue=function(c){var d=k.val();!1!==c&&a.options.getTextHandler&&(d=a.options.getTextHandler(d));return d};a.setWysiwygEditorValue=function(a){l().body.innerHTML=w(a)};a.setTextareaValue=function(a){k.val(a)};a.updateTextareaValue=function(){s()?
e.val(a.getTextareaValue(!1)):e.val(a.getWysiwygEditorValue())};w=function(c){var b=d.extend({},a.options.emoticons.more,a.options.emoticons.dropdown,a.options.emoticons.hidden);d.each(b,function(d,b){var e=a.regexEscape(d)+"(?=([^\\<\\>]*?<(?!/code)|[^\\<\\>]*?$))",f="";a.options.emoticonsCompat&&(e="((>|^|\\s){1})"+e+"(?=(\\s|$|<){1})",f="$1");c=c.replace(RegExp(e,"gm"),f+'<img src="'+b+'" data-sceditor-emoticon="'+d+'" />')});return c};a.regexEscape=function(a){return a.replace(/[\$\?\[\]\.\*\(\)\|]/g,
...
return"[quote"+a+"]"+c+"[/quote]"},html:function(b,c,a){"undefined"!==typeof c.defaultAttr&&(a="<cite>"+c.defaultAttr+"</cite>"+a);return"<blockquote>"+a+"</blockquote>"}},code:{tags:{code:null},isBlock:!0,format:"[code]{0}[/code]",html:"<code>{0}</code>"},left:{styles:{"text-align":["left","-webkit-left","-moz-left"]},isBlock:!0,format:"[left]{0}[/left]",html:'<div align="left">{0}</div>'},center:{styles:{"text-align":["center","-webkit-center","-moz-center"]},isBlock:!0,format:"[center]{0}[/center]",
html:'<div align="center">{0}</div>'},right:{styles:{"text-align":["right","-webkit-right","-moz-right"]},isBlock:!0,format:"[right]{0}[/right]",html:'<div align="right">{0}</div>'},justify:{styles:{"text-align":["justify","-webkit-justify","-moz-justify"]},isBlock:!0,format:"[justify]{0}[/justify]",html:'<div align="justify">{0}</div>'},youtube:{tags:{iframe:{"data-youtube-id":null}},format:function(b,c){return!b.attr("data-youtube-id")?c:"[youtube]"+b.attr("data-youtube-id")+"[/youtube]"},html:'<iframe width="560" height="315" src="http://www.youtube.com/embed/{0}" data-youtube-id="{0}" frameborder="0" allowfullscreen></iframe>'}};
d.sceditorBBCodePlugin.commandExists=function(b){return"undefined"!==typeof d.sceditorBBCodePlugin.bbcodes[b]};d.sceditorBBCodePlugin.setCommand=function(b,c,a,e,f){if(!b||!e||!f)return!1;d.sceditorBBCodePlugin.commandExists(b)||(d.sceditorBBCodePlugin.bbcodes[b]={});d.sceditorBBCodePlugin.bbcodes[b].format=e;d.sceditorBBCodePlugin.bbcodes[b].html=f;c&&(d.sceditorBBCodePlugin.bbcodes[b].tags=c);a&&(d.sceditorBBCodePlugin.bbcodes[b].styles=a);return!0};d.sceditorBBCodePlugin.defaultOptions={defaultSize:13,
defaultColor:"#111111",defaultFont:"Verdana, Arial, Helvetica, sans-serif"};d.fn.sceditorBBCodePlugin=function(b){return this.each(function(){new d.sceditorBBCodePlugin(this,b)})}})(jQuery);
